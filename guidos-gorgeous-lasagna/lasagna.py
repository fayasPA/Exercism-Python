...
def preparation_time_in_minutes(number_of_layers):
    ...
    :return: int - return preparation time (in minutes) derived from 'PREPARATION_TIME'.

    Function that takes the number of layers of lasagna needed as
    an argument and returns total prepation time needed.
    """
