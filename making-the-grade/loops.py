...
def letter_grades(highest):
    ...
    while grade_threshold < highest:
        ...
        grade_threshold = grade_threshold + int((highest - 40) / 4)
...
def student_ranking(student_scores, student_names):
    ...
    for index,score in enumerate(student_scores):
        student_rank = "{rank}. {student_name}: {student_score}"
        student_ranks.append(student_rank.format(rank=index + 1, student_name=student_names[index], student_score=score))
